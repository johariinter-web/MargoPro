      ...
      <div style={{
        ...
        <div style={{ padding: '36px 24px 16px', borderBottom: '1px solid #E5E7EB' }}>
          ...
          <div style={{ fontSize: 14, color: '#6B7280', lineHeight: 1.7 }}>
            Votre essai gratuit est terminé. Choisissez 5 produits à garder actifs. Les autres seront archivés - pas supprimés. Ils reviennent si vous passez au Premium.
          </div>
          <div style={{
