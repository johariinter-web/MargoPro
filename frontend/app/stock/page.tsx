    ...
    <div style={{ minHeight: '100dvh', background: T.bg, paddingBottom: 90, fontFamily: 'Manrope, sans-serif' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <input type="text" inputMode="decimal" value={champsEdition.tailleConditionnement} onChange={e => setChampsEdition(c => ({ ...c, tailleConditionnement: e.target.value }))} placeholder="Ex: 12" min="1"
                style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
            </div>
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <input type="text" inputMode="decimal" value={champsEdition.quantite} onChange={e => setChampsEdition(c => ({ ...c, quantite: e.target.value }))} placeholder="0" min="0" step="any"
                style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
            ...
            {[
              ...
              <div key={key} style={{ marginBottom: 10 }}>
                ...
                <input type="text" inputMode="decimal" value={champsEdition[key as keyof typeof champsEdition]} onChange={e => setChampsEdition(c => ({ ...c, [key]: e.target.value }))} placeholder={placeholder} min="0"
                  style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
              </div>
            ))}
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <input type="text" inputMode="decimal" autoFocus value={champsReappro.quantite} onChange={e => setChampsReappro(c => ({ ...c, quantite: e.target.value }))} placeholder="0" min="0"
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input type="text" inputMode="decimal" value={champsReappro.prixAchat} onChange={e => setChampsReappro(c => ({ ...c, prixAchat: e.target.value }))} placeholder={`Inchangé : ${champsEdition.prixAchat || '0'}`} min="0"
                style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
            </div>
              ...
              return (
                <>
                  <div style={{ marginBottom: hasData ? 4 : 14 }}>
                    ...
                    <input type="text" inputMode="decimal" value={champsPack.remise} onChange={e => setChampsPack(c => ({ ...c, remise: e.target.value }))} placeholder="Ex : 10" min="0" max="100"
                      style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
                  </div>
                  {hasData && (
      ...
      {showForm && (
        <div style={{ margin: '0 16px 12px', background: T.surface, borderRadius: 16, padding: 16, boxShadow: T.shadow }}>
          ...
          <div style={{ marginBottom: 10 }}>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: T.textSub, marginBottom: 5 }}>Unités par paquet (optionnel)</label>
            <input type="text" inputMode="decimal" value={champs.tailleConditionnement} onChange={e => setChamps(c => ({ ...c, tailleConditionnement: e.target.value }))} placeholder="Ex: 12 pour un carton de 12" min="1"
              style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
          </div>
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <input type="text" inputMode="decimal" value={champs.quantite} onChange={e => setChamps(c => ({ ...c, quantite: e.target.value }))} placeholder="0" min="0" step={Number(champs.tailleConditionnement) > 0 ? '1' : 'any'}
              style={{ width: '100%', border: `1.5px solid ${T.border}`, borderRadius: 10, padding: '10px 12px', fontSize: 15, color: T.text, background: T.bg, outline: 'none', fontFamily: 'Manrope, sans-serif', boxSizing: 'border-box' }} />
            ...
            <div style={{ background: T.surface, borderRadius: 16, padding: 16, boxShadow: T.shadow, marginBottom: 12 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                ...
                <div style={{ background: T.bgSubtle, borderRadius: 10, padding: '6px 12px', display: 'flex', alignItems: 'center', gap: 4 }}>
                  <input type="text" inputMode="decimal" min={1} max={365} value={morteSeuilStr}
